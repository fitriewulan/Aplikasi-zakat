      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><span>Login Amil</span><strong class="text-primary">LAZIS MS</strong></div>
            <p>ini hanya dapat dilogin oleh Karyawan Lazis masjid syuhada, silakan masuk menggunakan username dan password yang sudah terdaftar sebelumnya</p>
            <form id="login-form" action="<?= site_url('amil/auth/login_process')?>" method="post">
              <div class="form-group">
                 <div class="line"></div>
                 <label for="login-username" class="label-custom">User Name</label>
                <input id="login-username" type="text" name="username_amil" required="">
              </div>
              <div class="form-group">
                 <label for="login-password" class="label-custom">Password</label>
                <input id="login-password" type="password" name="password_amil" required="">
              </div>
